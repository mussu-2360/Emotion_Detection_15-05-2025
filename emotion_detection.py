...
# #  Save the model
# def save_model(pipeline, model_filename='emotion_model.pkl', vectorizer_filename='tfidf_vectorizer.pkl'):
#     joblib.dump(pipeline, model_filename)
#     print(f"Model saved as {model_filename}")

#     # Extract and save the TF-IDF vectorizer separately
#     tfidf_vectorizer = pipeline.named_steps['tfidf']
#     joblib.dump(tfidf_vectorizer, vectorizer_filename)
#     print(f"TF-IDF Vectorizer saved as {vectorizer_filename}")

# #  Demo interface for real-time prediction
# def predict_emotion(pipeline):
#     print("\nEmotion Detection Demo")
#     print("Enter 'quit' to exit")
